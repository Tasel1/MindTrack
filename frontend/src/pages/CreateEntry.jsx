...
const CreateEntryPage = () => {
  ...
  useEffect(() => {
    // In a real app, we would fetch emotions and tags from the API
    // For now, we'll use the predefined lists
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      navigate('/entries'); // Redirect to entries list after successful creation
    } catch (err) {
